            ...
            <div class="row">
                    ...
                    <div class="card card-details">
                            ...
                            <table class="table table-responsive-sm text-center">
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="http://ui-avatars.com/api/?name={{ $detail->username }}" height="60" class="rounded-circle">
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('checkout-remove', $detail->id) }}"><img src="{{ url('frontend/images/ic_del.png') }}" alt=""></a>
                                            </td>
                                        </tr>
                                        @empty
                                            <tr>
                        ...
                        <div class="member mt-3">
                            ...
                            <p class="disclaimer mb-0">
                                You are only able to invite member that has registered in Mumaza.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <p class="payment-intructions">Please complete payment before you
